...
public class StringContainsVowels {
    public static void main(String[] args) {
        ...
        */
        ...
        //Printing out the length of the different strings
        System.out.println("The length on string 1 ("+ input01 + ") is "+ strOneLength + ", the length of string 2 (" + input02 + ") is " + strTwoLength + " and the length of string 3 (" + input03 + ") is "+ strThreeLength);

        // Initializing global counters to be used.
        int counterA = 0;
        int counterB = 0;
        int counterC = 0;
        ...
        // Alternative solution using while loop and if else shorthand on string 3 (input03)
        int j = 0;
